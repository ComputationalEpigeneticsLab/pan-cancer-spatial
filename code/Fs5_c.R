...
geneset1<-read.delim('/data/geneset/genest_mp.txt',stringsAsFactors = F,check.names = F)
...
ecosystem_cluster_maker<-read.delim('/other_data/ecosystem_cluster_maker.txt',stringsAsFactors = F,check.names = F)
...
write.table(GSEA_ESscore,'/data/pic_data/MP_eco_GSEA/Imm_GSEA_ESscore.txt',quote = F,sep = '\t')
write.table(GSEA_NESscore,'/data/pic_data/MP_eco_GSEA/Imm_GSEA_NESscore.txt',quote = F,sep = '\t')
write.table(GSEA_FDR,'/data/pic_data/MP_eco_GSEA/Imm_GSEA_FDR.txt',quote = F,sep = '\t')

GSEA_ESscore<-read.delim('/data/pic_data/MP_eco_GSEA/Imm_GSEA_ESscore.txt')
GSEA_NESscore<-read.delim('/data/pic_data/MP_eco_GSEA/Imm_GSEA_NESscore.txt')
GSEA_FDR<-read.delim('/data/pic_data/MP_eco_GSEA/Imm_GSEA_FDR.txt')
...
print(p)
pdf('/pic/NMF_module/ecosystem_ImmGSEA2.pdf',width = 8,height = 4.5)
print(p)
dev.off()
