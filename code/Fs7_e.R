...
dir_Cyto<-'/data/10X Visium/Cytospace/'
...
write.table(all_step_TAM,'/data/pic_data/all_step_subTAM.txt',quote = F,sep = '\t',row.names = F)
...
###################################################
####按每个step画
pdf('/pic/subCAFTAM/subTAM_step_SPP1&FN1.pdf',width = 4,height = 8)
