...
dir_re<-'/data/pic_data/bdy_step1_MP/bdy_step_1_coreMP_immInfiltration/immNormal/'
...
for(j in 1:5){#j=1
  ...
  pdf(paste0('/pic/NMF_module/coreBdyImm/',step_n[j],'_cir_celltype_MP_heatmap.pdf'),width = 6,height = 6)
  circos.clear()
