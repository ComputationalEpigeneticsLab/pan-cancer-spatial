...
####CytoSpace
skcm12_subCellType<-read.delim('E:/Mirror/ST_analysis/data/10X Visium/Cytospace/skcm12_slice1/subCellType.txt',stringsAsFactors = F,check.names = F)
skcm13_subCellType<-read.delim('E:/Mirror/ST_analysis/data/10X Visium/Cytospace/skcm13_slice1/subCellType.txt',stringsAsFactors = F,check.names = F)

skcm12_subCellType<-skcm12_subCellType[,which(colnames(skcm12_subCellType)!='unknown')]
skcm12_subCellType<-apply(skcm12_subCellType,1,function(x) x/sum(x)) %>% t() %>% as.data.frame()
skcm13_subCellType<-skcm13_subCellType[,which(colnames(skcm13_subCellType)!='unknown')]
skcm13_subCellType<-apply(skcm13_subCellType,1,function(x) x/sum(x)) %>% t() %>% as.data.frame()
...
skcm12_data<-data.frame(slice='skcm12',
                        ...
                        TAM_C0=c(skcm12_subCellType[skcm12_step1,'TAM_C0'],skcm12_subCellType[skcm12_far,'TAM_C0']),
                        TAM_C1=c(skcm12_subCellType[skcm12_step1,'TAM_C1'],skcm12_subCellType[skcm12_far,'TAM_C1']),
                        TAM_C2=c(skcm12_subCellType[skcm12_step1,'TAM_C2'],skcm12_subCellType[skcm12_far,'TAM_C2']),
                        CAF=c(skcm12_subCellType[skcm12_step1,'CAF'],skcm12_subCellType[skcm12_far,'CAF']))
...
skcm13_data<-data.frame(slice='skcm13',
                        ...
                        TAM_C0=c(skcm13_subCellType[skcm13_step1,'TAM_C0'],skcm13_subCellType[skcm13_far,'TAM_C0']),
                        TAM_C1=c(skcm13_subCellType[skcm13_step1,'TAM_C1'],skcm13_subCellType[skcm13_far,'TAM_C1']),
                        TAM_C2=c(skcm13_subCellType[skcm13_step1,'TAM_C2'],skcm13_subCellType[skcm13_far,'TAM_C2']),
                        CAF=c(skcm13_subCellType[skcm13_step1,'CAF'],skcm13_subCellType[skcm13_far,'CAF']))
...
colnames(plot_2)
plot_col<-c("TAM_C0","TAM_C1","TAM_C2","CAF",'TAM')

#dir_pic22<-'E:/Mirror/ST_analysis/pic/subTAM&CAF_skcm/RCTD_box/'
dir_pic22<-'E:/Mirror/ST_analysis/pic/re/other/CytoSpace_new/'
